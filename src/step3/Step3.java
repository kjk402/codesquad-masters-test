...
public class Step3 {
    ...
    public static void commandExcution(String[] shell, int k, String[][] cube) {
        if (shell[k].equals("U")) {
            step3.MovingCube.left(3,cube);
            step3.MovingCube.rightRotate(3,0,cube);
        }
        if (shell[k].equals("U'")){
            step3.MovingCube.right(3,cube);
            step3.MovingCube.leftRotate(0,3,cube);
        }
        if (shell[k].equals("D'")) {
            step3.MovingCube.left(5,cube);
            step3.MovingCube.leftRotate(6,3,cube);
        }
        if (shell[k].equals("D")){
            step3.MovingCube.right(5,cube);
            step3.MovingCube.rightRotate(3,6,cube);
        }
        if (shell[k].equals("R")) {
            step3.MovingCube.up(5,9,cube);
            step3.MovingCube.rightRotate(6,3,cube);
        }
        if (shell[k].equals("R'")) {
            step3.MovingCube.down(5,9,cube);
            step3.MovingCube.leftRotate(3,6,cube);
        }
        if (shell[k].equals("L'")) {
            step3.MovingCube.up(3,11,cube);
            step3.MovingCube.leftRotate(3,0,cube);
        }
        if (shell[k].equals("L")) {
            step3.MovingCube.down(3,11,cube);
            step3.MovingCube.rightRotate(0,3,cube);
        }
        if (shell[k].equals("F'")) {
            step3.MovingCube.leftswift(2,6,cube);
            step3.MovingCube.leftRotate(3,3,cube);
        }
        if (shell[k].equals("F")) {
            step3.MovingCube.rightswift(2,6,cube);
            step3.MovingCube.rightRotate(3,3,cube);
        }
        if (shell[k].equals("B")) {
            step3.MovingCube.leftswift(0,8,cube);
            step3.MovingCube.rightRotate(9,3,cube);
        }
        if (shell[k].equals("B'")) {
            step3.MovingCube.rightswift(0,8,cube);
            step3.MovingCube.leftRotate(3,9,cube);
        }
    }
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            if (command.equals("random") ||command.equals("RANDOM")) {
                command = random();
            }
